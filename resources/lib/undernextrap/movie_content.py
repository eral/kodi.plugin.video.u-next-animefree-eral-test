...
class MovieContent():
    def __init__(self, movie_url, movie_headers, protocol, drm, mime, license_url, license_headers, license_post_data, license_response):
        # type: (MovieContent, str, dict[str,str], str, str, str, str, dict[str,str], str, str) -> None
    ...
    def __str__(self):
        # type: (MovieContent) -> dict[str, object]
    ...
    @property
    def movie_headers(self):
        # type: (MovieContent) -> dict[str, str]
    ...
    @property
    def license_post_data(self):
        # type: (MovieContent) -> str
        return self.__license_post_data

    @property
    def license_response(self):
        # type: (MovieContent) -> str
